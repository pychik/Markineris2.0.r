...
from utilities.param_lists import (SHOE_GENDERS, SHOE_MATERIALS_UP_LINEN, SHOE_MATERIALS_BOTTOM,
                                   ...
                                   LINEN_PRELOAD_START, LINEN_TEXTILE_TYPES, PARFUM_MATERIAL_PACKAGES,
                                   PARFUM_PACKAGE_TYPES,
                                   PARFUM_START, PARFUM_PRELOAD_START, PARFUM_TNVED, PARFUM_TYPES, PARFUM_VOLUMES,
                                   CLOTHES_DICT, CLOTHES_GENDERS,
                                   CLOTHES_GENDERS_ORDER, CLOTHES_START, CLOTHES_PRELOAD_START, CLOTHES_TNVED,
                                   CLOTHES_TYPES,
                                   ...
                                   COUNTRIES_CODES,
                                   CHECK_ORDER_STAGES, COMMON_COLORS, SHOE_START_EXT_029, SHOE_START_EXT_046,
                                   LINEN_START_EXT, PARFUM_START_EXT,
                                   CRM_PS_DICT, CLOTHES_CONTENT, CLOTHES_NAT_CONTENT, CLOTHES_UPPER, SHOE_TYPES_CODES,
                                   SHOE_SIZES_ND, SHOE_SIZES_CODES,
                                   USER_TRANSLATE_DICT, CLOTHES_SIZES_FULL, CLOTHES_SIZES_DESCRIPTION,
                                   CLOTHES_OLD_TNVED, ALL_CLOTHES_TNVED,
                                   COMPLICATED_COLORS, ALL_COLORS, UT_REPORT_START_FILL, UT_REPORT_START_ELSE,
                                   CLOTHES_TYPES_CODES, CLOTHES_START_EXT_029, CLOTHES_START_EXT_046,
                                   CLOTHES_GENDERS_ORDER_046, ALL_SOCKS_TNVEDS, SOCKS_TYPES_SIZES_DICT,
                                   SOCKS_SIZE_TYPES, SOCKS_ST_DICT,
                                   SUB_CATEGORIES_DICT, BIG_LINEN_TNVED, BIG_SHOE_TNVED, ORDER_AGGREGATION_TNVEDS)
...
class Settings(BaseSettings):
    ...
    ORDER_AGGREGATION_TNVEDS_LIST: list = list(ORDER_AGGREGATION_TNVEDS)
    ORDER_AGGREGATION_TNVEDS_DICT: dict = ORDER_AGGREGATION_TNVEDS
