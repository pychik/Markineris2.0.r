...
- Список стран для `cosmetics` и `toys` совпадает с обычными заказами: без РД берутся `default_countries` конкретной подкатегории, при включенном РД - полный список стран.
