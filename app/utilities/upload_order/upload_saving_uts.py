...
def upload_clothes_st(order_list: list, order: Order, subcategory: str = None) -> Order:
    for el in order_list:
        ...
        new_clothes_order = Clothes(trademark=el[0].strip(),
                                    ...
                                    article_price=0, tax=0)
        if subcategory in [ClothesSubcategories.underwear.value,
                           ClothesSubcategories.swimming_accessories.value,
                           ClothesSubcategories.hats.value,
                           ClothesSubcategories.gloves.value,
                           ClothesSubcategories.shawls.value, ]:
