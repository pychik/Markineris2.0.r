...
Olc = namedtuple("Olc", "order order_list company_type company_name company_idn\
            edo_type edo_id mark_type trademark orders_pos_count pos_count total_price price_exist subcategory")

OLC_NONE = Olc(None, None, None, None, None, None, None, None, None, None, None, None, None, None)
