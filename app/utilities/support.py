...
def helper_get_filters_transactions(tr_type: int = None, tr_status: int = None) -> tuple:
    """
    ...
    link_filters = f'tr_type={tr_type_raw}&tr_status={tr_status}&start_from={date_from_raw}&start_to={date_to_raw}&'
