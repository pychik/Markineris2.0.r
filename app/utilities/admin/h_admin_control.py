...
def h_index():
    ...
    users_stmt = text(f"""SELECT au.id as id,
                                ...
                                COUNT(CASE WHEN u.created_at >= DATE_TRUNC('DAY', NOW()) - interval '1 DAY' and u.created_at < DATE_TRUNC('DAY', NOW()) and u.role='{settings.ORD_USER}' THEN 1 END) as new_users_count,
