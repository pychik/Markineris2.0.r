...
ar_categories_types: dict = {settings.Clothes.CATEGORY: settings.Clothes.TYPES + UNDERWEAR_TYPES + SWIMMING_ACCESSORIES_TYPES + HATS_TYPES + GLOVES_TYPES + SHAWLS_TYPES,
