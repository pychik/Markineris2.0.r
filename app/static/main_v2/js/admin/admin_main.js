   ...
   let modal_input = '';
    if (type === 'agent_fee'){
       ...
       modal_input = '<input name="agent_fee_value" id="agent_fee_value_check" class="form-control"  type="number" min="0" max="40" step="1" value="${u_fee_or_tl}" placeholder="Введите ставку 0-40%" required>'
        ...
        modal_label= '<label for="agent_tl_value">Укажите лимит отрицательного баланса агента в руб от 0 до 1200000, р.</label>';
        modal_input = '<input name="agent_tl_value" id="agent_tl_value_check" class="form-control" type="number" min="0" max="1200000" step="100" value="${u_fee_or_tl}" placeholder="Введите лимит агента" required>'
    }
